    ...
    return (
        <div>
            <footer>
                ...
                <div><h5>Contact</h5>
                <ul><li><FontAwesomeIcon icon={['fas','envelope']}  size="1x" className="mx-3 my-1"/> test1234@gmail.com</li>
                
                <li><FontAwesomeIcon icon={['fas','phone']} size="1x" className="mx-3 my-1"/>0123456789</li>
